...
kubectl krew install karbon # nutanix karbon utils
kubectl krew install popeye # popeye scanner for potential resource issues
kubectl krew install df-pv # shows disk usage
kubectl krew install topology # explore region topology for nodes or pods
kubectl krew install service-tree # status for ingresses, services, and their backends
